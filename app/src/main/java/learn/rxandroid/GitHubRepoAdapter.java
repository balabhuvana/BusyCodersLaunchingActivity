...
public class GitHubRepoAdapter extends BaseAdapter {
    ...
    private List<GitHubRepoRxAndroid> gitHubRepos = new ArrayList<>();
    ...
    @Override
    public GitHubRepoRxAndroid getItem(int position) {
    ...
    public void setGitHubRepos(@Nullable List<GitHubRepoRxAndroid> repos) {
        if (repos == null) {
            return;
        }
        gitHubRepos.clear();
    ...
    private static class GitHubRepoViewHolder {
        ...
        public void setGitHubRepo(GitHubRepoRxAndroid gitHubRepo) {
